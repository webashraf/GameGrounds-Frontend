...
const WelcomeAdminDashboard = () => {
  ...
  return (
    <div className="px-5 lg:pt-0 pt-20 shadow-lg bg-white flex flex-col justify-center items-center w-full lg:w-[90%] mx-auto pb-10">
      <div className="w-full lg:p-5 rounded-lg mt-10 lg:mt-20">
