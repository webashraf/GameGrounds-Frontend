    ...
    <>
      ...
      <div className="lg:px-20 px-5">
        ...
        <div className="flex lg:flex-row flex-col  items-center justify-center gap-8 ">
          <div className="w-full lg:w-1/2  bg-black overflow-hidden rounded-lg">
            ...
            >
              ...
              <div className="w-full p-3 rounded-lg bg-gray-100">
                ...
                <textarea
                  ...
                  className="text-md w-full h-[200px] p-10 px-4 py-3 border border-gray-300 rounded-lg shadow-sm transition duration-300 ease-in-out transform focus:-translate-y-1 focus:outline-blue-300 hover:shadow-lg hover:border-blue-300 bg-gray-100"
